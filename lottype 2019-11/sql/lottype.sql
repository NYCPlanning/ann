-- This script is an attempt to identify lot types using spatial queries. The first
-- two are for block assemblages and interior lots. The second two were meant for
-- alleys and inside lots, but they probably don't work well. We would probably need
-- to write a script to identify inside, corner, through, and alley lots.
